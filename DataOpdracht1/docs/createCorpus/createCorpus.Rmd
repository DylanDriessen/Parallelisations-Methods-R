...
Deze resultaten zijn bekomen op een dataset van 500.000 documenten.
De tijd zal zich lineair verhouden t.o.v. de dataset.
Bevindingen op grotere datasets bevestigen dit, maar zijn niet geplaatst geraakt in een microbenchmark door problemen met het RAM.
```{r}
readRDS(file = "./resources/corpusBenchmark.rds")
```

Uit deze resultaten kunnen we besluiten dat het package Quanteda het snelste is.
